...
- Calendar Event seedをPostgreSQLへ投入し、予定候補の衝突をSafety Checkで確認する
...
4. Calendar read-only OAuthを追加する (ローカルCalendar availability adapterは実装済み。予定作成はせず、衝突検知と提案に留める)
